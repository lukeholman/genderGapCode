...
neaten.the.data <- function(dd){
  dd[, names(dd) %in% c("gender.ratio.at.present", "low.CI.1", "up.CI.1", "current.rate.of.change", "low.CI.2", "up.CI.2", "low.CI.3", "up.CI.3", "r", "c")] <- round(dd[, names(dd) %in% c("gender.ratio.at.present", "low.CI.1", "up.CI.1", "current.rate.of.change", "low.CI.2", "up.CI.2", "low.CI.3", "up.CI.3", "r", "c")], 3)  # some rounding
